...
namespace luautils
{
    ...
    std::tuple<int32, uint8, uint8> OnUseWeaponSkill(CCharEntity* PChar, CBaseEntity* PMob, CWeaponSkill* wskill, uint16 tp, bool primary, action_t& action);// returns: damage, tphits landed, extra hits landed
