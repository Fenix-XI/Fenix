...
function onTrade(player,npc,trade)
	...
	-- trade:hasItemQty(1042,1); 		-- Treasure Key
	...
	-- Player traded a key.
	if ((trade:hasItemQty(1042,1) or trade:hasItemQty(1115,1) or trade:hasItemQty(1023,1) or trade:hasItemQty(1022,1)) and trade:getItemCount() == 1) then 
		...
		if (AFHandsActivated == 6 and player:hasKeyItem(OLD_GAUNTLETS) == false) then 
			questItemNeeded = 1;
		else
