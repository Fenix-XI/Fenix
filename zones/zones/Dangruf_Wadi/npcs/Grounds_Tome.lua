...
function onEventUpdate(player,csid,option)
    ...
    updateGov(player,csid,option,639,640,641,642,643,644,645,646,646,646);
end;
...
function onEventFinish(player,csid,option)
    -- printf("CSID: %u",csid);
    -- printf("RESULT: %u",option);
    finishGov(player,csid,option,639,640,641,642,643,644,645,646,646,646,GOV_MSG_DANGRUF_WADI);
end;
