...
-- Dynamis dialogs
       YOU_CANNOT_ENTER_DYNAMIS = 7861; -- You cannot enter Dynamis
 PLAYERS_HAVE_NOT_REACHED_LEVEL = 7863; -- Players who have not reached levelare prohibited from entering Dynamis.
UNUSUAL_ARRANGEMENT_OF_BRANCHES = 7873; -- There is an unusual arrangement of branches here.
