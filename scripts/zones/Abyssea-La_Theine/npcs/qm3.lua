...
--[[
    if (trade:hasItemQty(2893,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 2893); -- Inform payer what items they need.
    elseif (GetMobAction(17318436) == ACTION_NONE) then -- mob not already spawned from this
