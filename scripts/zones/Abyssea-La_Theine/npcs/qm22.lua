...
--[[
    if (trade:hasItemQty(2897,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 2897); -- Inform payer what items they need.
    elseif (GetMobAction(17318440) == ACTION_NONE) then -- mob not already spawned from this
