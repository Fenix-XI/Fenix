...
--[[
    if (trade:hasItemQty(2899,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 2899); -- Inform payer what items they need.
    elseif (GetMobAction(17318442) == ACTION_NONE) then -- mob not already spawned from this
