...
--[[
    if (trade:hasItemQty(3265,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 3265); -- Inform payer what items they need.
    elseif (GetMobAction(17818045) == ACTION_NONE) then -- mob not already spawned from this
