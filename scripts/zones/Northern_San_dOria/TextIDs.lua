...
-- Quest Dialog
   OLBERGIEUT_DIALOG = 11255; -- Friar Faurbellant is on retreat at the Crag of Holla. Please give
...
-- Other Dialog
 GUILBERDRIER_DIALOG = 11131; -- A magic shop, you say? A bit of magic would come in handy... I know! I'll have my daughter study it for me!
    ABIOLEGET_DIALOG = 11207; -- All of Altana's children are welcome here.
     PELLIMIE_DIALOG = 11208; -- Is this your first time here? Join us in prayer!
   FITTESEGAT_DIALOG = 11209; -- Paradise is a place without fear, without death!
      MAURINE_DIALOG = 11210; -- Papsque Shamonde sometimes addresses the city from the balcony, you know. I long for his blessing, if but once!
     PRERIVON_DIALOG = 11211; -- With each sermon, I take another step closer to Paradise.
      MALFINE_DIALOG = 11212; -- Truly fortunate are we that words of sacrament are read every day!
     COULLENE_DIALOG = 11213; -- Goddess above, deliver us to Paradise!

     GUILERME_DIALOG = 11327; -- Behold Chateau d'Oraguille, the greatest fortress in the realm!

     PHAVIANE_DIALOG = 11331; -- This is Victory Arch. Beyond lies Southern San d'Oria.
     SOCHIENE_DIALOG = 11332; -- You stand before Victory Arch. Southern San d'Oria is on the other side.
     PEPIGORT_DIALOG = 11333; -- This gate leads to Port San d'Oria.
   RODAILLECE_DIALOG = 11334; -- This is Ranperre Gate. Fiends lurk in the lands beyond, so take caution!

      GALAHAD_DIALOG = 11347; -- Welcome to the Consulate of Jeuno. I am Galahad, Consul to San d'Oria.
       ISHWAR_DIALOG = 11348; -- May I assist you?
       ARIENH_DIALOG = 11349; -- If you have business with Consul Galahad, you'll find him inside.
       EMILIA_DIALOG = 11347; -- Welcome to the Consulate of Jeuno.

       HELAKU_DIALOG = 11379; -- Leave this building, and you'll see a great fortress to the right. That's Chateau d'Oraguille. And be polite; San d'Orians can be quite touchy.

     KASARORO_DIALOG = 11418; -- Step right outside, and you'll see a big castle on the left. That's Chateau d'Oraguille. They're a little touchy in there, so mind your manners!

     MAURINNE_DIALOG = 11455; -- This part of town is so lively, I like watching everybody just go about their business.

     AIVEDOIR_DIALOG = 11489; -- That's funny. I could have sworn she asked me to meet her here...
      CAPIRIA_DIALOG = 11490; -- He's late! I do hope he hasn't forgotten.
    BERTENONT_DIALOG = 11491; -- Stars are more beautiful up close. Don't you agree?

     GILIPESE_DIALOG = 11512; -- Nothing to report!

      BONCORT_DIALOG = 12037; -- Hmm... With magic, I could get hold of materials a mite easier. I'll have to check this art out. 
      CAPIRIA_DIALOG = 12038; -- A flyer? For me? Some reading material would be a welcome change of pace, indeed!
...
-- Shop Texts
   DOGGOMEHR_SHOP_DIALOG = 11525; -- Welcome to the Blacksmiths' Guild shop.
    LUCRETIA_SHOP_DIALOG = 11526; -- Blacksmiths' Guild shop, at your service!

  CAUZERISTE_SHOP_DIALOG = 11593; -- Welcome! San d'Oria Carpenters' Guild shop, at your service.

    ANTONIAN_OPEN_DIALOG = 11608; -- Interested in goods from Aragoneu?
     BONCORT_SHOP_DIALOG = 11609; -- Welcome to the Phoenix Perch!
 PIRVIDIAUCE_SHOP_DIALOG = 11610; -- Care to see what I have?
  PALGUEVION_OPEN_DIALOG = 11611; -- I've got a shipment straight from Valdeaunia!
     VICHUEL_OPEN_DIALOG = 11612; -- Fauregandi produce for sale!
     ARLENNE_SHOP_DIALOG = 11613; -- Welcome to the Royal Armory!
   TAVOURINE_SHOP_DIALOG = 11614; -- Looking for a weapon? We've got many in stock!

  ANTONIAN_CLOSED_DIALOG = 11618; -- The Kingdom's influence is waning in Aragoneu. I cannot import goods from that region, though I long to.
PALGUEVION_CLOSED_DIALOG = 11619; -- Would that Valdeaunia came again under San d'Orian dominion, I could then import its goods!
   VICHUEL_CLOSED_DIALOG = 11620; -- I'd make a killing selling Fauregandi produce here, but that region's not under San d'Orian control!
  ATTARENA_CLOSED_DIALOG = 11621; -- Once all of Li'Telor is back under San d'Orian influence, I'll fill my stock with unique goods from there!
EUGBALLION_CLOSED_DIALOG = 11622; -- I'd be making a fortune selling goods from Qufim Island...if it were only under San d'Orian control!
