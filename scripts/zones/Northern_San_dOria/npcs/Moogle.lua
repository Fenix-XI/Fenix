...
-- 
-----------------------------------
package.loaded["scripts/zones/Northern_Sand_dOria/TextIDs"] = nil;
...
function onTrigger(player,npc,csid,itemID)
    ...
    elseif (player:getQuestStatus(4,100) == QUEST_ACCEPTED and mogBackVac == false) then
    ...
    elseif (player:getQuestStatus(4,101) == QUEST_ACCEPTED and mogBackVac == false) then
    ...
    elseif (player:getQuestStatus(4,102) == QUEST_ACCEPTED and mogBackVac == false) then
