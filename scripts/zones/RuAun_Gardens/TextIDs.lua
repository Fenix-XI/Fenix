...
FULL_INVENTORY_AFTER_TRADE = 6383; -- You cannot obtain the <item>. Try trading again after sorting your inventory.
   ...
   NOTHING_OUT_OF_ORDINARY = 6398; -- There is nothing out of the ordinary here.
    FISHING_MESSAGE_OFFSET = 7045; -- You can't fish here.
            HOMEPOINT_SET = 11637; -- Home point set!
...
-- Other dialog
IT_IS_ALREADY_FUNCTIONING = 7300; -- It is already functioning.
           SKY_GOD_OFFSET = 7350; -- A strange insignia pointing north is carved into the wall.
         SKY_GOD_OFFSET_2 = 7351; -- A strange insignia pointing east is carved into the wall.
         SKY_GOD_OFFSET_3 = 7352; -- A strange insignia pointing west is carved into the wall.
         SKY_GOD_OFFSET_4 = 7353; -- A strange insignia pointing south is carved into the wall.
