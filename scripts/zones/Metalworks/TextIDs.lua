...
MISSION_DIALOG_CID_TO_AYAME =  7568; -- Give it to one of his Mythril Musketeers instead. Ayame and Naji should be on guard near the President's Office. Either one will do.
   ...
   EXTENDED_MISSION_OFFSET  =  8587; -- Go to Ore Street and talk to Medicine Eagle. He says he was there when the commotion started.

-- Other dialog
NOTHING_OUT_OF_ORDINARY =  6453; -- There is nothing out of the ordinary here.
     GLAROCIQUET_DIALOG =  8199; -- I am Speaker Name, a Temple Knight. I am one of the guards charged with overseeing San d'Oria's conquest campaign.
   LEXUN_MARIXUN_DIALOG =  8201; -- I am Speaker Name, a War Warlock. I am one of the guards charged with overseeing Windurst's conquest campaign.
...
VICIOUS_EYE_SHOP_DIALOG =  7996; -- Hi. This is where blacksmiths buy what they need.
  ...
  TAKIYAH_CLOSED_DIALOG =  9957; -- Maybe someday I'll be able to sell goods from Qufim Island... Someday...
    TAKIYAH_OPEN_DIALOG =  9958; -- Hey, it's your lucky day! I've got a fresh batch of goods straight from the island of Qufim!
