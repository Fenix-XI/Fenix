...
NOTHING_HAPPENS =  119; -- Nothing happens...
       LEYPOINT = 7389; -- An eerie red glow emanates from this stone platform

-- Harvesting
HARVESTING_IS_POSSIBLE_HERE = 7397; -- Harvesting is possible here if you have

-- Quest: NAVIGATING_THE_UNFRIENDLY_SEAS
PLACE_HYDROGAUGE = 7333; -- You set the # in the glowing trench.
 ENIGMATIC_LIGHT = 7334; -- is giving off an enigmatic light.
