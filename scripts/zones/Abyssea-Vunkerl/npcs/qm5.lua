...
--[[
    if (trade:hasItemQty(3102,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 3102); -- Inform payer what items they need.
    elseif (GetMobAction(17666491) == ACTION_NONE) then -- mob not already spawned from this
