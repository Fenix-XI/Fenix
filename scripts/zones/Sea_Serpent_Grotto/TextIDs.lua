...
-- Sahagin Key Door Texts
 SAHAGIN_DOOR_INSIDE = 7324; -- The door is tightly shut.
SAHAGIN_DOOR_OUTSIDE = 7325; -- This door has an oddly shaped keyhole. It looks as if once you enter, you may not be able to get out the way you came in.
 SAHAGIN_DOOR_TRADED = 7326; -- breaks

-- Secret Door Texts; The first five are the same for each door, with the 6th and 7th being unique
    FIRST_CHECK = 7330; -- You do not see anything out of the ordinary.
   SECOND_CHECK = 7331; -- You do not see anything out of the ordinary...
    THIRD_CHECK = 7332; -- It looks like a rock wall.
   FOURTH_CHECK = 7333; -- It looks like a rock wall...
    FIFTH_CHECK = 7334; -- You see a small indentation in the wall.
   SILVER_CHECK = 7335; -- You see something silver glittering around the indentation.
  MYTHRIL_CHECK = 7336; -- You find something that looks like mythril dust scattered about the indentation.
     GOLD_CHECK = 7337; -- You see something gold glittering around the indentation.
COMPLETED_CHECK = 7338; -- It is a door you can open using
