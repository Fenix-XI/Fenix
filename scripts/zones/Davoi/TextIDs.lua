...
ITEM_CANNOT_BE_OBTAINED = 6379; -- You cannot obtain the item <item>. Come back after sorting your inventory.
 ...
 FISHING_MESSAGE_OFFSET = 7204; -- You can't fish here.
   ...
   CAVE_HAS_BEEN_SEALED_OFF = 7343; -- The cave has been sealed off by some sort of barrier.
   MAY_BE_SOME_WAY_TO_BREAK = 7344; -- There may be some way to break through.
POWER_OF_THE_ORB_ALLOW_PASS = 7346; -- The disruptive power of the orb allows passage through the barrier.
         QUEMARICOND_DIALOG = 7365; -- I can't believe I've lost my way!
            YOU_SEE_NOTHING = 7399; -- There is nothing here.
     AN_ORCISH_STORAGE_HOLE = 7441; -- An Orcish storage hole. There is something inside, but you cannot open it without a key.
                     A_WELL = 7443; -- A well, presumably dug by Orcs.
