...
--[[
    if (trade:hasItemQty(2903,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 2903); -- Inform payer what items they need.
    elseif (GetMobAction(16838899) == ACTION_NONE) then -- mob not already spawned from this
