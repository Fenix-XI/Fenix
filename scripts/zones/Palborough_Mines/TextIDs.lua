...
-- Refiner Dialog
SOMETHING_FALLS_OUT_OF_THE_MACHINE = 7362; -- Something falls out of the machine!
   THE_MACHINE_SEEMS_TO_BE_WORKING = 7359; -- The machine seems to be working, but you cannot discern its purpose.
     YOU_CANT_CARRY_ANY_MORE_ITEMS = 7365; -- There seems to be more left in the machine, but you can't carry any more items.

-- Mining
MINING_IS_POSSIBLE_HERE = 7386; -- Mining is possible here if you have

-- Treasure Coffer/Chest Dialog
CHEST_UNLOCKED = 7400; -- You unlock the chest!
    CHEST_FAIL = 7401; -- Fails to open the chest.
...
CHEST_ILLUSION = 7406; -- The chest was but an illusion...
  CHEST_LOCKED = 7407; -- The chest appears to be locked.
