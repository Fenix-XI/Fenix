...
-- Assault
CANNOT_ENTER = 7454; -- You cannot enter at this time.  Please wait a while before trying again.
AREA_FULL = 7455; -- This area is fully occupied. You were unable to enter.
MEMBER_NO_REQS = 7459; -- Not all of your party members meet the requirements for this objective.  Unable to enter area.
MEMBER_TOO_FAR = 7463; -- One or more party members are too far away from the entrance.  Unable to enter area.
