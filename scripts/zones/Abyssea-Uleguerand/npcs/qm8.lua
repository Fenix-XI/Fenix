...
--[[
    if (trade:hasItemQty(3255,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 3255); -- Inform payer what items they need.
    elseif (GetMobAction(17813938) == ACTION_NONE) then -- mob not already spawned from this
