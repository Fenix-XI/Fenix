...
--[[
    if (trade:hasItemQty(3234,1) == false or trade:hasItemQty(3244,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 3234 ,3244); -- Inform payer what items they need.
    elseif (GetMobAction(17670571) == ACTION_NONE) then -- mob not already spawned from this
