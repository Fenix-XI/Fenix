...
TELEPOINT_HAS_BEEN_SHATTERED = 7746; -- The telepoint has been shattered into a thousand pieces...
              CHOCOBO_TRACKS = 7878; -- There are chocobo tracks on the ground here.

-- Quest Dialogs
 UNLOCK_SUMMONER = 7566; -- You can now become a summoner.
UNLOCK_CARBUNCLE = 7567; -- You can now summon Carbuncle.
...
-- ZM4 Dialog
    CANNOT_REMOVE_FRAG = 7581; -- It is an oddly shaped stone monument. A shining stone is embedded in it, but cannot be removed...
 ALREADY_OBTAINED_FRAG = 7582; -- You have already obtained this monument's . Try searching for another.
ALREADY_HAVE_ALL_FRAGS = 7583; -- You have obtained all of the fragments. You must hurry to the ruins of the ancient shrine!
       FOUND_ALL_FRAGS = 7584; -- You have obtained ! You now have all 8 fragments of light!
       ZILART_MONUMENT = 7585; -- It is an ancient Zilart monument.
