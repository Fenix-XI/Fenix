...
-- ??? that spawns NM Yara Ma Yha Who
     SPROUT_LOOKS_WITHERED = 7547; -- There is something sprouting from the ground here. It looks a little withered.
REPULSIVE_CREATURE_EMERGES = 7548; -- A repulsive creature emerges from the ground!
SPROUT_DOES_NOT_NEED_WATER = 7549; -- The sprout does not need any more water now.
     SPROUT_LOOKING_BETTER = 7551; -- The sprout is looking better.
...
-- Other Texts
TELEPOINT_HAS_BEEN_SHATTERED = 7504; -- The telepoint has been shattered into a thousand pieces...
