...
--[[
    if (trade:hasItemQty(2916,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 2916); -- Inform payer what items they need.
    elseif (GetMobAction(16961918) == ACTION_NONE) then -- mob not already spawned from this
