...
-- Signs
SIGN = 7391; -- North: Grand Duchy of Jeuno, Sauromugue Champaign South: Pashhow Marshlands

-- Conquest Base
CONQUEST_BASE = 7067; -- Tallying conquest results...

-- Legion
AWAIT_YOUR_CHALLENGE = 12160; -- We await your challenge
  LACK_LEGION_POINTS = 12197; -- It would seem that you lack the necessary amount of Legion points.
