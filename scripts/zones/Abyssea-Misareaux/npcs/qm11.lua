...
--[[
    if (trade:hasItemQty(3096,1) == false) then -- Player is missing at least one required item.
        player:startEvent(1010, 3096); -- Inform payer what items they need.
    elseif (GetMobAction(17662474) == ACTION_NONE) then -- mob not already spawned from this
