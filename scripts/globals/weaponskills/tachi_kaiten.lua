...
function onUseWeaponSkill(player, target, wsID, tp, primary)
    ...
    local params = {};
    params.numHits = 1;
    params.ftp100 = 4.5; params.ftp200 = 5; params.ftp300 = 5.5;
    params.str_wsc = 0.7; params.dex_wsc = 0.0; params.vit_wsc = 0.0; params.agi_wsc = 0.0; params.int_wsc = 0.0; params.mnd_wsc = 0.0; params.chr_wsc = 0.0;
    ...
    if (damage > 0) then
        ...
        player:addStatusEffect(EFFECT_AFTERMATH, 6, 0, amDuration, 0, 10);
    end
