...
function onUseWeaponSkill(player, target, wsID, tp, primary)
    ...
    params.str_wsc = 0.0; params.dex_wsc = 0.0; params.vit_wsc = 0.0; params.agi_wsc = 0.0; params.int_wsc = 0.80; params.mnd_wsc = 0.0; params.chr_wsc = 0.20;
    ...
    if (damage > 0) then
        player:addStatusEffect(EFFECT_AFTERMATH, 8, 0, 30, 0, 10);
