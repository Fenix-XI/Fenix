...
CURE_POWER  = 1.100; -- Multiplies amount healed from Healing Magic, including the relevant Blue Magic.
SPELL_POWER = 0.800; -- Multiplies damage dealt by Elemental and Divine Magic.
BLUE_POWER  = 0.950; -- Multiplies damage dealt by most Blue Magic.
DRAIN_POWER = 0.900; -- Multiplies amount drained by Drain, Aspir, and relevant Blue Magic spells.
ITEM_POWER  = 1.000; -- Multiplies the effect of items such as Potions and Ethers.
WEAPON_SKILL_POWER  = 1.100; -- Multiplies damage dealt by Weapon Skills.
...
-- DYNAMIS SETTINGS
    BETWEEN_2DYNA_WAIT_TIME = .85;        -- wait time between 2 Dynamis (in real day) min: 1 day
...
KILLER_EFFECT = 15; -- Intimidation percentage from killer job traits.
...
STONESKIN_CAP = 400; -- soft cap for hp absorbed by stoneskin
...
RIVERNE_PORTERS = 60; -- Time in seconds that Unstable Displacements in Cape Riverne stay open after trading a scale.
